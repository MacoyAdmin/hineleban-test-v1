...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="https://i0.wp.com/suntrustblog.com/wp-content/uploads/2020/03/20B1-500x500-1.png" alt="AdminLTELogo" height="60" width="60">
  </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">Successfuly Picked-up</span>
                      <span class="float-right"><b>10</b>/12</span>
                      <div class="progress progress-sm">
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">₱3,210.43</h5>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block">
                      ...
                      <h5 class="description-header">₱1,200.00</h5>
                      <span class="description-text">REVENUE LOSS</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
