...
<x-head data="Contact Us | Hineleban Store"/>
  ...
  <div class="container" style="background:#f0f0f0">
    <div class="row">
        <h1 style="text-align:center;margin-top:100px"><strong>Order History</strong></h1>
        <div class="card">
              <!-- /.card-header -->
              <div class="card-body p-0">
                <table class="table">
                  ...
                  <tbody>
                      ...
                      @if($customerId == $item->customerid && $item->jobstatusid == 4)
                    <tr>
                      <td>{{$item->transactionid}}</td>
                      <td>{{$item->transfer}}</td>
                      <td>₱ {{$item->totalPrice}}.00</td>
                      <td><span class="badge <?php if($item->jobstatusid==1){echo "bg-primary";}?>"><?php
